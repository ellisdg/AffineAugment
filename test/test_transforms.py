...
import torch
from augment import augment_affine
import unittest
...
class TestTransforms(unittest.TestCase):
    ...
    def test_rotate_x(self):
        ...
        affine_rotate_x = augment_affine(self.image.affine, rotate_params=angle, shape=self.image.shape[1:])
    ...
    def test_rotate_y(self):
        ...
        affine_rotate_y = augment_affine(self.image.affine, rotate_params=angle, shape=self.image.shape[1:])
    ...
    def test_rotate_z(self):
        ...
        affine_rotate_z = augment_affine(self.image.affine, rotate_params=angle, shape=self.image.shape[1:])
    ...
    def test_rotate(self):
        ...
        affine_rotate = augment_affine(self.image.affine, rotate_params=angle, shape=self.image.shape[1:])
    ...
    def test_translate(self):
        ...
        affine_translate = augment_affine(self.image.affine, translate_params=translation)
    ...
    def test_simple_flip(self):
        ...
        affine_flip = augment_affine(image.affine, flip_params=flip_params, shape=image.shape[1:])
        assert torch.all(affine_flip[:3, 3] == 0)

    def test_flip_x(self):
        flip_params = torch.tensor([True, False, False])
        monai_flip = Flip(0)(self.image)
        affine_flip = augment_affine(self.image.affine, flip_params=flip_params, shape=self.image.shape[1:])
    ...
    def test_shear(self):
        ...
        affine_shear = augment_affine(self.image.affine, shear_params=shear_params, shape=self.image.shape[1:])
